    ...
    >
      ...
      <div className="flex items-center justify-between p-5 pb-0 mt-6">
        <div className="flex items-center gap-2 overflow-hidden">
          <div className="flex-shrink-0 w-5 h-5 rounded bg-white/5 flex items-center justify-center p-0.5">
            {m.leagueLogo ? <img src={m.leagueLogo} className="object-contain w-full h-full" alt="" /> : <ShieldCheck size={12} className="text-white/20" />}
          </div>
      ...
      <div className="flex items-center justify-between px-4 py-8">
        ...
        <div className="w-[36%] flex flex-col items-center justify-center">
          ...
          {isLive && <div className="mt-2 text-[8px] font-black text-red-500 uppercase tracking-widest flex items-center gap-1">PLAYING NOW</div>}
        </div>
      ...
      <div className="mx-4 mb-4 p-2.5 rounded-xl bg-white/5 border border-white/5 flex items-center gap-2">
        ...
        <p className="text-[9px] font-bold text-white/60 line-clamp-1 italic">{m.aiPick || "Waiting for tactical data..."}</p>
      </div>
